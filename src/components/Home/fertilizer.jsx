...
import productsData from "../../data/producttwo"; // Adjust path as per your project structure
  ...
  return (
    <div className="container mx-auto p-4 font-poppins">
      ...
      <h1 className="text-2xl font-bold">
          {category_id ? "Fertilizer Product" : "Fertilizer Product"}
        </h1>
              ...
              <div className="p-4">
                ...
                >
                  <Image
                    src={product.image}
                    alt={product.name}
                    className="w-full h-56 p-4  transition-transform duration-500 transform group-hover:scale-105"
                  />
                </Link>
